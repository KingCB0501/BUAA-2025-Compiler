...
public class UnaryExp extends Node {
    ...
    public boolean isFromPrimaryExp() {
        return primaryExp != null;
    }

    public boolean isFromFuncCall() {
        return this.ident_token != null;
    }

    public boolean isFromUnaryExp() {
        return unaryExp != null;
    }

    public Token tryGetIdent() {
        if (primaryExp != null) {
            return primaryExp.tryGetIdent();
        } else if (ident_token != null) {
            return ident_token;
        } else {
            return unaryExp.tryGetIdent();
        }
    }
