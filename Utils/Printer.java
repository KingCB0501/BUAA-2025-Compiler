...
public class Printer {
    ...
    private static final String LLVMOptimizeOutput = "llvm_optimize.txt";
    private static final String LLVMMidOptimizeOutput = "llvm_mid_optimize.txt";
    ...
    public static void printLlvmOptimize(String output) {
        try (FileWriter fileWriter = new FileWriter(LLVMOptimizeOutput)) {
            fileWriter.write(output);
        } catch (IOException e) {
            System.err.println("Error writing LLVM Optimize to file " + LLVMOptimizeOutput);
        }
    }

    public static void printLlvmMidOptimize(String output) {
        try (FileWriter fileWriter = new FileWriter(LLVMMidOptimizeOutput)) {
            fileWriter.write(output);
        } catch (IOException e) {
            System.err.println("Error writing LLVM Optimize to file " + LLVMOptimizeOutput);
        }
